...
Popup {
    ...
    contentItem: ColumnLayout {
        ...
        ColumnLayout {
            ...
            Text { text: qsTr("Auto-Switch Profiles"); color: Theme.text; font.pixelSize: 17; font.weight: Font.DemiBold }
            Text {
                text: qsTr("Automatically switch profiles when a specific application is in focus.")
