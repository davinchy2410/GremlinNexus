...
Popup {
    ...
    function openFor(devicePath_, inputName_) {
        ...
        vjoyDeviceCombo.currentIndex = 0;
        root.open();
    }
    ...
    contentItem: ColumnLayout {
        ...
        ColumnLayout {
            ...
            Text { text: "Axis-to-Button Zones"; color: Theme.text; font.pixelSize: 17; font.weight: Font.DemiBold }
            Text {
        ...
        ColumnLayout {
            ...
            Text { text: "Travel"; color: Theme.subtext0; font.pixelSize: 11 }
            ...
            RowLayout {
                Layout.fillWidth: true
                Text { text: "0%"; color: Theme.overlay0; font.pixelSize: 10 }
                Item { Layout.fillWidth: true }
                Text { text: "100%"; color: Theme.overlay0; font.pixelSize: 10 }
            }
        }
        ...
        ColumnLayout {
            ...
            Repeater {
                ...
                delegate: RowLayout {
                    ...
                    Text { text: "Min %"; color: Theme.subtext0; font.pixelSize: 11 }
                    TextField {
                    ...
                    Text { text: "Max %"; color: Theme.subtext0; font.pixelSize: 11 }
                    TextField {
