...
Popup {
    ...
    contentItem: ColumnLayout {
        ...
        ColumnLayout {
            ...
            Text {
                text: qsTr("Each press fires the next remap below, then wraps back to the first.")
        ...
        ColumnLayout {
            ...
            Repeater {
                ...
                delegate: RowLayout {
                    ...
                    Text { text: qsTr("Output Device"); color: Theme.subtext0; font.pixelSize: 11 }
                    OutputDeviceCombo {
                        id: stepDeviceCombo
                ...
                onClicked: {
                    const jsonActions = root.steps.map((s) => {
                        return { actionType: "ButtonRemapHandler",
                                 targetDeviceType: s.targetDeviceType || "vjoy",
                                 targetOutputId: s.targetOutputId,
