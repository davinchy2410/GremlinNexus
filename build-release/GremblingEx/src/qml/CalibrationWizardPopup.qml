...
Popup {
    ...
    contentItem: ColumnLayout {
        ...
        ColumnLayout {
            ...
            Text { text: "Axis Calibration"; color: Theme.text; font.pixelSize: 17; font.weight: Font.DemiBold }
            Text {
        ...
        ColumnLayout {
            ...
            Text {
                ...
                text: root.wizardState === "calibrating"
                    ? "Move axes in full circles..."
                    : "Click Start, then move every stick/axis on this device through its full range of motion (full circles work best for gimbaled sticks)."
            }
        }
        ...
        RowLayout {
            ...
            ToolButton {
                label: root.wizardState === "calibrating" ? "Save Calibration" : "Start Calibration"
                onClicked: {
